            ...
            <div>
              ...
              <div style={{ maxWidth: 700, margin: "100px auto" }}>
                <form className="flex items-center" onSubmit={submitHandeler}>
                  ...
                  <button
                    type="submit"
                    className="inline-flex items-center py-2.5 px-3 ml-2 text-sm font-medium text-white bg-blue-800 border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                  >
                    <svg
                      aria-hidden="true"
